  ...
  return (
    ...
    lg:grid lg:grid-cols-10">
        ...
        <div className="flex flex-col items-center
         justify-center py-2 lg:min-h-screen">
            ...
            <img className="w-44 rounded-xl object-cover
             lg:h-96 lg:w-72" src="https://links.papareact.com/8sg" 
            alt="" />
            </div>
           
            <div className=" space-y-2 text-center p-5">
                <h1 className='text-4xl font-bold text-white'>HymnsBharat Apps</h1>
                <h2 className='text-xl text-gray-300'>A collection of HymnBharat Apes who lives & breathe Next</h2>
            </div>
        </div>
      </div>
      {/*Right */}
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
       ...
       <p className=' pt-2 text-xl text-green-500'>20/98 NFT's channel</p>
       </div>
       <button className="h-16  mt-10 w-full bg-red-600 rounded-full font-bold text-white">
        Mint NFT (0.01 ETH)
       </button>
